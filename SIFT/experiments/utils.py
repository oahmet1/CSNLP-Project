# https://raw.githubusercontent.com/muyeby/AMRBART/5461144b2e1984d324919f459028b46b335d4496/spring/spring_amr/modeling_bart.py
...
# TODO document where this code is from
...
#code copied from https://huggingface.co/transformers/v3.2.0/_modules/transformers/generation_utils.html
...
class AMRBartForConditionalGeneration(bart.PretrainedBartModel):
    ...
    def _generate_beam_search(
        ...
        generated_hyps = [
            bart.BeamSearchScorer(num_beams, max_length, length_penalty, early_stopping=early_stopping)
